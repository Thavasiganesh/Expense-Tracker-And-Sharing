...
$ret=mysqli_query($con,"SELECT year(ExpenseDate) as rptyear,SUM(ExpenseCost) as totalyear FROM expensetbl  where (year(ExpenseDate) BETWEEN '$fdate' and '$tdate') && (UserID='$userid') group by year(ExpenseDate)");
$cnt=1;
$totalsexp=0;
