...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select UserID from userstbl where  Email='$email' && Password='$password' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
     $_SESSION['ETASuid']=$ret['UserID'];
	...
	<hr />
		...
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4"  >
			<div class="login-panel panel panel-default">
				<div class="panel-heading" align="center">User Log in</div>
