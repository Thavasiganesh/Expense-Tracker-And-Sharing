...
if(isset($_POST['submit']))
  {
    ...
    $ret=mysqli_query($con, "select Email from userstbl where Email='$email' ");
    $result=mysqli_fetch_array($ret);
    if($result>0){
$msg="This email  associated with another account";
    }
    else{
    $query=mysqli_query($con, "insert into userstbl(FullName, MobileNumber, Email,  Password) value('$fname', '$mobno', '$email', '$password' )");
    if ($query) {
...
<head>
	...
	<title>Expense Tracker And Sharing - Signup</title>
...
{
alert('Password and Repeat Password field should be same');
    ...
    echo $msg;
						...
						<fieldset>
							...
							<div class="checkbox">
								...
								<a href="index.php" class="btn btn-primary" style="margin-left:-70px;">Login</a></span>
							</div>
							 </fieldset>
					</form>
				</div>
