...
if (strlen($_SESSION['ETASuid']==0)) {
    ...
    if(isset($_GET['delid'])) {
        ...
        $query=mysqli_query($con,"delete from expensetbl where ExpenseID='$rowid'");
        if($query) {
...
<head>
    ...
    <title>Expense Tracker And Sharing || Manage Expense</title>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered mg-b-0">
                                    ...
                                    <tbody>
                                        ...
                                        $ret=mysqli_query($con,"select * from expensetbl where UserID='$userid'");
                                        $cnt=1;
                                        while ($row=mysqli_fetch_array($ret)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="manage_expense.php?delid=<?php echo $row['ExpenseID']; ?>">Delete</a>
                                                </td>
                                            </tr>
                                            <tr style="display: none;">
                                                <td colspan="5">
                                                    <form action="update_expense.php" method="POST">
                                                        ...
                                                        <input type="text" name="expenseItem" value="<?php echo $row['ExpenseItem']; ?>">
                                                        <input type="text" name="expenseCost" value="<?php echo $row['ExpenseCost']; ?>">
                                                        <input type="text" name="expenseDate" value="<?php echo $row['ExpenseDate']; ?>">
